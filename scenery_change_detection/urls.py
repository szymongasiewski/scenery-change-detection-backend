...
urlpatterns = [
    ...
    path('testimg/', views.TestImageRequestSendingView.as_view(), name='testimg'),
    # path('user/history/images/', views.UserHistoryImagesView.as_view(), name="user-history-images"),
